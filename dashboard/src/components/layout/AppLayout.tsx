    ...
    <div className="flex h-dvh overflow-hidden bg-background">
      ...
      {isMobile && mobileOpen ? (
        <div
          ...
          className="fixed inset-y-0 left-0 z-50 animate-slide-in-right"
        >
      ...
      <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
        ...
        <main
          id="main-content"
          tabIndex={-1}
          className="app-canvas flex-1 overflow-y-auto px-3 py-5 outline-none sm:px-4 md:py-6 lg:px-5 2xl:px-6"
        >
